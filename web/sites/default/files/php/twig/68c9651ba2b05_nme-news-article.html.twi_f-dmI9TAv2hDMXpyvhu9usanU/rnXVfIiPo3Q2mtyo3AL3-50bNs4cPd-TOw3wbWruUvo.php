...
/* modules/custom/nme_news/templates/nme-news-article.html.twig */
class __TwigTemplate_cf741a02f06ba02a0ef0ee40c609b59f extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        // line 7
        yield "<article";
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", ["nme-news-article"], "method", false, false, true, 7), "html", null, true);
        yield ">
  ";
        // line 8
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["article"] ?? null), "thumbnail_url", [], "any", false, false, true, 8)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 9
            yield "    <div class=\"relative overflow-hidden\">
      <img src=\"";
            // line 10
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["article"] ?? null), "thumbnail_url", [], "any", false, false, true, 10), "html", null, true);
            yield "\" 
           alt=\"";
            // line 11
      ...
      <div class=\"absolute top-4 left-4\">
        <span class=\"bg-red-600 text-white text-xs px-2 py-1 rounded-full font-medium\">NME</span>
      </div>
    </div>
  ";
        }
  ...
  <div class=\"p-6\">
    ...
    <div class=\"flex items-center justify-between\">
      ...
      ";
        // line 44
        if ((($tmp =  !CoreExtension::getAttribute($this->env, $this->source, ($context["article"] ?? null), "thumbnail_url", [], "any", false, false, true, 44)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 45
            yield "        <span class=\"text-xs text-gray-400\">NME</span>
      ";
        }
        // line 47
        yield "    </div>
    ...
    {
        return "modules/custom/nme_news/templates/nme-news-article.html.twig";
    }
    ...
    {
        return new Source("", "modules/custom/nme_news/templates/nme-news-article.html.twig", "/var/www/html/web/modules/custom/nme_news/templates/nme-news-article.html.twig");
    }
